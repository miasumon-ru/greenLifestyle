...
const Footer = () => {
    return (
        <div>
            ...
            <footer className="footer p-10 bg-base-200 roboto text-base-content">
                <nav>
                    <h6 className="footer-title">Services</h6>
                    <a className="link link-hover">Rent Apartment</a>
                    <a className="link link-hover">Online Application</a>
                    <a className="link link-hover">Customer Support</a>
                    <a className="link link-hover">Indoor Air Quality</a>
                </nav>
                <nav>
